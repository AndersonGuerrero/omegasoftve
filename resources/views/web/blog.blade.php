					...
					@foreach($blogs as $item)
						...
						<div class="news-block-one" style = "border: 1px solid #cecbcb;">
							<div class="inner-box">
								...
								<h3 style = "padding-right: 20px; padding-left: 20px;" ><a href="{{ route('blog-name', str_slug($item->title)) }}">{{$item->title}}</a></h3>
								<div style = "padding-right: 20px; padding-left: 20px;" class="post-info">Publicado: {{$item->created_at->format('d-m-Y')}}</div>
