...
@section('content')
    ...
    <section class="main-slider">
        ...
        <!--Scroll Down Button-->
        <div class="scroll-down-btn scroll-to-target" data-target=".services-two"></div>
    ...
    <section class="cases-section-two">
    	<div class="auto-container">
            ...
            <div class="row clearfix">
                	...
                	<div class="inner-box">
                        ...
                        <div class="hover-box">
                            <div class="hover-content">
                                <h3><a href="projects.html">Crispent ethiopie philippe</a></h3>
                                <div class="categories"><a href="projects.html">Business</a>|<a href="projects.html">Corporate</a></div>
                                <div class="link-box"><a href="projects.html">Read More <span class="fa fa-long-arrow-right"></span></a></div>
                            </div>
                        </div>
                    </div>
                </div>
            	...
            	<div class="case-block-two col-md-6 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <div class="hover-box">
                            <div class="hover-content">
                                <h3><a href="projects.html">Nouvelle trouvait supplice</a></h3>
                                <div class="categories"><a href="projects.html">Business</a>|<a href="projects.html">Corporate</a></div>
                                <div class="link-box"><a href="projects.html">Read More <span class="fa fa-long-arrow-right"></span></a></div>
                            </div>
                        </div>
            	...
            	<div class="case-block-two col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <div class="hover-box">
                            <div class="hover-content">
                                <h3><a href="projects.html">Jikan Financial Statement</a></h3>
                                <div class="categories"><a href="projects.html">Business</a>|<a href="projects.html">Corporate</a></div>
                                <div class="link-box"><a href="projects.html">Read More <span class="fa fa-long-arrow-right"></span></a></div>
                            </div>
                        </div>
            ...
            <div class="view-all text-center"><a href="projects.html" class="theme-btn btn-style-two">View All</a></div>
    ...
    <section class="team-section">
    	<div class="auto-container">
        	<!--Heading-->
            <div class="sec-title-two centered">
                <h1>Our Professional Advisors</h1>
            </div>
    ...
    <!--Why Us Section-->
    <section class="why-us" style="background-image:url(images/background/5.jpg)">
    	<div class="outer-container clearfix">
            <!--Content Column-->
            <div class="content-column">
            	<div class="inner">
                    ...
                    <div class="text">The green zone is available to everyone, but not just anyone can join. The first step into the green zone is the step.</div>
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <ul class="list-style-one">
                                <li>24/7 Supports</li>
                                <li>Powerful Surver</li>
                                <li>Work Deadline</li>
                            </ul>
                        </div>
                    </div>
                    <div class="link-box"><a href="contact.html" class="theme-btn btn-style-two">Get Start</a></div>
                    ...
                    <div class="inner">
                        ...
                        <ul class="accordion-box">
                            ...
                            <li class="accordion block">
                                <div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus fa fa-plus"></span> <span class="icon icon-minus fa fa-minus"></span></div>How to remove a business risk ? </div>
                            ...
                            <!--Block-->
                            <li class="accordion block">
                                <div class="acc-btn active"><div class="icon-outer"><span class="icon icon-plus fa fa-plus"></span> <span class="icon icon-minus fa fa-minus"></span></div>Evidence shows advisers already working ?</div>
                            ...
                            <!--Block-->
                            <li class="accordion block">
                                <div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus fa fa-plus"></span> <span class="icon icon-minus fa fa-minus"></span></div>Conflicted advice can substantially compromise ?</div>
                                <div class="acc-content">
                                    <div class="content">
                                        <div class="text">The green zone is available to everyone, but not just anyone can join. The first step into the green zone is the step in to your client’s future and look back at the advice solutions and services you provided.</div>
                                    </div>
                            ...
                            <!--Block-->
                            <li class="accordion block">
                                <div class="acc-btn"><div class="icon-outer"><span class="icon icon-plus fa fa-plus"></span> <span class="icon icon-minus fa fa-minus"></span></div>Our ethos reflects our vision ?</div>
                                <div class="acc-content">
                                    <div class="content">
                                        <div class="text">The green zone is available to everyone, but not just anyone can join. The first step into the green zone is the step in to your client’s future and look back at the advice solutions and services you provided.</div>
                                    </div>
            ...
            <div class="row clearfix">
                ...
                <div class="text-column col-md-7 col-sm-12 col-xs-12">
                	<div class="inner">
                    	<!--Heading-->
                        <div class="sec-title-two">
                            <h1>Our Success Facts</h1>
                        </div>
                        <div class="text">This product is meant for educational purposes only. Any resemblance to real persons, living or dead is coincidental. Void where prohibited.</div>
                        
                        <div class="fun-facts">
                        	<div class="row clearfix">
                            	<div class="count-column col-md-4 col-sm-4 col-xs-12">
                                	<div class="inner-box count-box">
                                    	<div class="count-outer"><span class="count-text" data-speed="5000" data-stop="20000">0</span>+</div>
                                ...
                                <div class="count-column col-md-4 col-sm-4 col-xs-12">
                                	<div class="inner-box count-box">
                                    	<div class="count-outer"><span class="count-text" data-speed="5000" data-stop="90">0</span>%</div>
                                    	<h4 class="counter-title">Success Rate</h4>
                                    </div>
                                </div>
                                <div class="count-column col-md-4 col-sm-4 col-xs-12">
                                	<div class="inner-box count-box">
                                    	<div class="count-outer"><span class="count-text" data-speed="3000" data-stop="35">0</span></div>
                                    	<h4 class="counter-title">Expert Advisors</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
